...
namespace moleQule.Library.Common
{
	...
	/// </summary>
    [Serializable()]
    public class TPVs : BusinessListBaseEx<TPVs, TPV>
    {
        ...
        public static TPVs GetList() { return GetList(false); }
        ...
        /// <returns>Lista de los elementos de la tabla en la base de datos</returns>
        public static TPVs GetList(bool retrieve_childs)
        {
            if (!TPV.CanEditObject())
				throw new System.Security.SecurityException(Library.Resources.Messages.USER_NOT_ALLOWED);
            ...
            if (nHManager.Instance.UseDirectSQL)
                criteria.Query = TPVs.SELECT();
            
            TPV.BeginTransaction(criteria.SessionCode);

            //No criteria. Retrieve all de List
            return DataPortal.Fetch<TPVs>(criteria);
        }
        ...
        private void Fetch(CriteriaEx criteria)
        {
            try
            {
				...
				if (nHMng.UseDirectSQL)
                {
                    ...
                    while (reader.Read())
                        this.AddItem(TPV.GetChild(reader, Childs));
                }
            }
            catch (Exception ex)
            {
        ...
        protected override void DataPortal_Update()
        {
            ...
            foreach (TPV obj in DeletedList)
                obj.DeleteSelf(this);
        ...
        public static string SELECT() { return TPV.SELECT(0); }
		public static string SELECT(QueryConditions conditions) { return TPV.SELECT(conditions, true); }
