...
{
    partial class RegistroEditForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
			...
			this.PanelesV.Panel2MinSize = 67;
			this.HelpProvider.SetShowHelp(this.PanelesV, true);
			this.PanelesV.Size = new System.Drawing.Size(515, 255);
			this.PanelesV.SplitterDistance = 209;
			// 
			// Submit_BT
			// 
			this.Submit_BT.Location = new System.Drawing.Point(100, 6);
			this.HelpProvider.SetShowHelp(this.Submit_BT, true);
			// 
			// Cancel_BT
			// 
			this.Cancel_BT.Location = new System.Drawing.Point(167, 6);
			...
			this.Paneles2.Size = new System.Drawing.Size(513, 43);
			// 
			// Imprimir_Button
			// 
			this.Imprimir_Button.Location = new System.Drawing.Point(340, 6);
			this.HelpProvider.SetShowHelp(this.Imprimir_Button, true);
			// 
			// Docs_BT
			// 
			this.Docs_BT.Location = new System.Drawing.Point(250, 6);
			this.HelpProvider.SetShowHelp(this.Docs_BT, true);
			// 
			// ProgressBK_Panel
			// 
			this.ProgressBK_Panel.Location = new System.Drawing.Point(48, 46);
			// 
			// RegistroEditForm
			// 
			this.ClientSize = new System.Drawing.Size(515, 255);
			this.HelpProvider.SetHelpNavigator(this, System.Windows.Forms.HelpNavigator.TopicId);
			this.Name = "RegistroEditForm";
