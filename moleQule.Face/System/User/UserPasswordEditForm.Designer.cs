...
{
	partial class UserPasswordEditForm
    {
        /// <summary>
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(UserPasswordEditForm));
			...
			// Nombre_TB
			// 
			resources.ApplyResources(this.Nombre_TB, "Nombre_TB");
			this.ErrorMng_EP.SetError(this.Nombre_TB, resources.GetString("Nombre_TB.Error"));
			this.Nombre_TB.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(0)))), ((int)(((byte)(0)))), ((int)(((byte)(192)))));
			this.HelpProvider.SetHelpKeyword(this.Nombre_TB, resources.GetString("Nombre_TB.HelpKeyword"));
			this.HelpProvider.SetHelpNavigator(this.Nombre_TB, ((System.Windows.Forms.HelpNavigator)(resources.GetObject("Nombre_TB.HelpNavigator"))));
			this.HelpProvider.SetHelpString(this.Nombre_TB, resources.GetString("Nombre_TB.HelpString"));
			this.ErrorMng_EP.SetIconAlignment(this.Nombre_TB, ((System.Windows.Forms.ErrorIconAlignment)(resources.GetObject("Nombre_TB.IconAlignment"))));
			this.ErrorMng_EP.SetIconPadding(this.Nombre_TB, ((int)(resources.GetObject("Nombre_TB.IconPadding"))));
			this.HelpProvider.SetShowHelp(this.Nombre_TB, ((bool)(resources.GetObject("Nombre_TB.ShowHelp"))));
			// 
			// SaveFile_SFD
			// 
			...
			this.Name = "UserPasswordEditForm";
