 ...
 */
function apply_template($tpl_file, $vars = array(), $include_globals = false)
{
	  extract($vars);
...
if ($method == "POST") {
	...
	$templateFileName = 'ResponseTemplate-es.php';
	
	$vars['uploadName'] = $result["uploadName"];
	
	$result["html"] = apply_template('ResponseTemplate.php', $vars);
